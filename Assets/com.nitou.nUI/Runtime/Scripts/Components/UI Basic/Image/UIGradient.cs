...
namespace Nitou.UI {
    ...
    public class UIGradient : BaseMeshEffect {
        ...
        [SerializeField] Gradient _effectGradient = new Gradient() { colorKeys = new GradientColorKey[] { new GradientColorKey(Color.black, 0), new GradientColorKey(Color.white, 1) } };
